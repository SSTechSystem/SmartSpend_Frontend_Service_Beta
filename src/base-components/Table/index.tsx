...
function Table({
  ...
  return (
    ...
    >
      <table
        className={twMerge([
          "w-full text-left border-spacing-y-[5px]",
...
Table.Th = ({ className, ...props }: ThProps) => {
  ...
  return (
    <th
      className={twMerge([
        "font-medium text-[13px] sm:text-sm px-5 py-3 border-b-2 dark:border-darkmode-300",
...
Table.Td = ({ className, ...props }: TdProps) => {
  ...
  return (
    <td
      className={twMerge([
        "px-5 py-1 border-b dark:border-darkmode-300 text-xs sm:text-[13px]",
        table.dark && "border-slate-600 dark:border-darkmode-300",
        table.bordered && "border-l border-r border-t",
        table.sm && "px-4 py-2",
        className,
